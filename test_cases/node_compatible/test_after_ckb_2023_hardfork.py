...
# https: // github.com / nervosnetwork / ckb / pull / 4227
# 这是 0.112.1 和 0.113.0-rc1 的一个差异。
# 112 版本之前的dev  dao 计算是错误的，所以113之后去掉兼容性测试
#
...
#         self.cluster.ckb_nodes.append(node)
#
#     def test_04_sync_successful_ge_112(self):
#         node = self.CkbNode.init_dev_by_port(self.CkbNodeConfigPath.V112, "node_compatible/current/node7", 8130,
#                                              8330)
#         node.prepare()
#         node.start()
#         node.connected(self.node_current)
